...
It's important to call `cy.server()` beforehand, else you can't manage the behavior of network requests.

With `as` you define an Alias for the route so that you can use it inside your tests like this:
